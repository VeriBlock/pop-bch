...
#ifndef INTEGRATION_REFERENCE_BCH_PAYLOADS_PROVIDER_HPP
#define INTEGRATION_REFERENCE_BCH_PAYLOADS_PROVIDER_HPP
...
#endif //INTEGRATION_REFERENCE_BCH_PAYLOADS_PROVIDER_HPP
