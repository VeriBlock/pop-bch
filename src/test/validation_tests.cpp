...
//    int maxHalvings = 64;
//    Amount nInitialSubsidy = VeriBlock::getCoinbaseSubsidy(50 * COIN, 0, params);
//
//    // for height == 0
...
//        Amount nSubsidy = GetBlockSubsidy(nHeight, params);
...
BOOST_AUTO_TEST_CASE(subsidy_limit_test) {
    ...
    for (int nHeight = 0; nHeight < 14000000; nHeight += 1000) {
        Amount nSubsidy = GetBlockSubsidy(nHeight, *chainParams);
